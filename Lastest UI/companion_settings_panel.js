...
(function (global) {
  ...
  const SCENE_KEYS = [
    ...
    'first_words', 'bestiary', 'summon_march', 'spend_indicator', 'free_promos', 'double_points',
  ...
  const TABS = [
    ...
    { id: 'first_words', label: 'Welcome toasts' },
  ...
  const FIELD_GROUPS = {
    ...
    first_words: uiFields('ui.', [
      { section: 'Zone' },
      { key: 'first_words_enabled', type: 'bool', label: 'Enabled' },
      { key: 'first_words_zone_x_px', type: 'int', label: 'Zone X' },
      { key: 'first_words_zone_y_px', type: 'int', label: 'Zone Y' },
      { key: 'first_words_zone_width_px', type: 'int', label: 'Zone width', min: 64, max: 1920 },
      { key: 'first_words_zone_height_px', type: 'int', label: 'Zone height', min: 0, max: 1080 },
      { key: 'first_words_zone_bottom_margin_px', type: 'int', label: 'Bottom margin' },
      { section: 'Look' },
      { key: 'first_words_chrome_style', type: 'chrome', label: 'Chrome style' },
      { key: 'first_words_chrome_scale', type: 'float', label: 'Chrome scale', min: 0.5, max: 4, step: 0.05 },
      { key: 'first_words_font_size_px', type: 'int', label: 'Font size', min: 8, max: 96 },
      { key: 'first_words_font_color', type: 'color', label: 'Font color' },
      { key: 'first_words_padding_h_px', type: 'int', label: 'Pad H', min: 0, max: 64 },
      { key: 'first_words_padding_v_px', type: 'int', label: 'Pad V', min: 0, max: 64 },
      { key: 'first_words_text_align', type: 'select', label: 'Align', options: ALIGNS },
      { key: 'first_words_text_shadow', type: 'bool', label: 'Text shadow' },
      { key: 'first_words_pop_scale', type: 'bool', label: 'Pop scale' },
      { section: 'Timing' },
      { key: 'first_words_queue_max', type: 'int', label: 'Queue max', min: 1, max: 32 },
      { key: 'first_words_default_ttl_sec', type: 'float', label: 'Hold (sec)', min: 0.5, max: 60, step: 0.25 },
      { key: 'first_words_fade_in_sec', type: 'float', label: 'Fade in', min: 0.05, max: 5, step: 0.05 },
      { key: 'first_words_fade_out_sec', type: 'float', label: 'Fade out', min: 0.05, max: 5, step: 0.05 },
    ]),
    ...
    corners: uiFields('ui.', [
      ...
      { section: '9-challenge deaths' },
      { key: 'nine_challenge_deaths_panel_visible', type: 'bool', label: '9c deaths visible' },
      { key: 'nine_challenge_deaths_corner', type: 'select', label: '9c corner', options: CORNERS },
      { key: 'nine_challenge_deaths_margin_x', type: 'int', label: '9c margin X' },
      { key: 'nine_challenge_deaths_margin_y', type: 'int', label: '9c margin Y' },
      { key: 'nine_challenge_deaths_padding_h_px', type: 'int', label: '9c pad H' },
      { key: 'nine_challenge_deaths_padding_v_px', type: 'int', label: '9c pad V' },
      { key: 'nine_challenge_deaths_font_size_px', type: 'int', label: '9c font', min: 8, max: 48 },
      { key: 'nine_challenge_deaths_font_color', type: 'color', label: '9c color' },
      { key: 'nine_challenge_deaths_chrome_style', type: 'chrome', label: '9c chrome' },
      { key: 'nine_challenge_deaths_chrome_scale', type: 'float', label: '9c chrome scale', min: 0.5, max: 4, step: 0.05 },
      { section: 'Starting soon' },
      { key: 'starting_soon_visible', type: 'bool', label: 'Starting soon visible' },
      { key: 'starting_soon_x_px', type: 'int', label: 'Soon X' },
      { key: 'starting_soon_y_px', type: 'int', label: 'Soon Y' },
      { key: 'starting_soon_scale', type: 'float', label: 'Soon scale', min: 0.25, max: 12, step: 0.05 },
    ]),
    live_water: uiFields('ui.', [
      { section: 'Size' },
      { key: 'live_water_bottom_bar_px', type: 'int', label: 'Bottom bar height' },
      { key: 'live_water_top_bar_px', type: 'int', label: 'Top bar height' },
      ...
      { key: 'live_water_top_gradient_fade_start', type: 'float', label: 'Top fade start Y', min: 0, max: 1, step: 0.01 },
      { key: 'live_water_top_gradient_fade_end', type: 'float', label: 'Top fade end Y (black at top)', min: 0, max: 1, step: 0.01 },
    ...
    vertical_zones: uiFields('ui_vertical.', [
      ...
      { key: 'show_first_words', type: 'bool', label: 'Show first words' },
      ...
      { key: 'show_nine_challenge_deaths', type: 'bool', label: 'Show 9c deaths' },
      { key: 'show_starting_soon', type: 'bool', label: 'Show starting soon' },
      ...
      { section: 'First Words zone' },
      { key: 'first_words_zone_x_px', type: 'int', label: 'First Words X' },
      { key: 'first_words_zone_y_px', type: 'int', label: 'First Words Y' },
      { key: 'first_words_zone_width_px', type: 'int', label: 'First Words W' },
      { key: 'first_words_zone_height_px', type: 'int', label: 'First Words H' },
      { key: 'first_words_zone_bottom_margin_px', type: 'int', label: 'First Words bottom margin' },
      { section: 'Water' },
      { key: 'live_water_bottom_bar_px', type: 'int', label: 'Water bottom bar' },
      { key: 'live_water_top_bar_px', type: 'int', label: 'Water top bar' },
      ...
      { key: 'live_water_top_gradient_fade_start', type: 'float', label: 'Water top fade start', min: 0, max: 1, step: 0.01 },
      { key: 'live_water_top_gradient_fade_end', type: 'float', label: 'Water top fade end', min: 0, max: 1, step: 0.01 },
      { key: 'live_water_top_edge_feather_v_px', type: 'int', label: 'Water top feather' },
      { section: 'Corners' },
      { key: 'spend_indicator_corner', type: 'select', label: 'Spend corner', options: CORNERS },
      { key: 'spend_indicator_margin_x', type: 'int', label: 'Spend margin X' },
      { key: 'spend_indicator_margin_y', type: 'int', label: 'Spend margin Y' },
