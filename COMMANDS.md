...
When enabled, chatters are assigned alternating roles on first chat: **helper** or **hurter**. Helpers earn bonus points when you kill a boss; hurters earn when you die. Each side gets **50% off** certain commands: helpers on bee, ward, buff; hurters on curse, gas, trap, debuff. **!myside** shows your current side. **!switch** costs 100 pts and has a long cooldown — choose wisely!

| Command | Description |
|---------|-------------|
| **!myside** | Remind yourself which side (helper/hurter) you're on. No cost. |
| **!switch** | Switch from helper to hurter or vice versa. 100 pts, long cooldown. |
...
| **!corruptally** | **Helper only.** Summon a corrupted ally from the current biome (40 pts). |
...
| **!bee** | Summon an allied bee next to the hero for 50 turns (30 pts). Fights for you like Elixir of Honeyed Healing. |
